...
(define-language ArithL (e ::= v (+ e e) (* e e)) (v ::= natural))
...
(define-extended-language ArithCtx ArithL (E ::= hole (+ v E) (+ E e) (* v E) (* e E)))
#|
